...
// LOGISTICS HERO SVG
// ============================================================
const logistics = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" fill="none">
  <defs>
...
// TEXTILE HERO SVG
// ============================================================
const textile = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" fill="none">
  <defs>
...
// ============================================================
const construction = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" fill="none">
  <defs>
...
// MARKETING HERO SVG
// ============================================================
const marketing = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" fill="none">
  <defs>
  ...
  <text x="448" y="725" text-anchor="middle" font-family="DM Sans, Arial, sans-serif" font-size="12" font-weight="600" fill="var(--label-teal, #0d7a6e)">Social</text>
  <g filter="url(#kNodeShadow)"><circle cx="240" cy="625" r="50" fill="#14b8a6"/><g transform="translate(240,625)" stroke="#fff" stroke-width="2.2" fill="none" stroke-linecap="round" stroke-linejoin="round"><circle cx="0" cy="0" r="16"/><line x1="0" y1="-12" x2="0" y2="12"/><line x1="-10" y1="-6" x2="10" y2="-6"/><line x1="-8" y1="6" x2="8" y2="6"/></g>
  <rect x="175" y="635" width="124" height="34" rx="17" fill="var(--label-bg, #fff)" stroke="#14b8a6" stroke-width="1.5"/>
  <text x="237" y="657" text-anchor="middle" font-family="DM Sans, Arial, sans-serif" font-size="12" font-weight="600" fill="var(--label-teal, #0d7a6e)">Revenue</text>
</svg>`;

// Write all files
fs.writeFileSync(path.join(assetsDir, 'logistics-hero.svg'), logistics, 'utf8');
console.log('✓ logistics-hero.svg written');

fs.writeFileSync(path.join(assetsDir, 'textile-hero.svg'), textile, 'utf8');
console.log('✓ textile-hero.svg written');

fs.writeFileSync(path.join(assetsDir, 'construction-hero.svg'), construction, 'utf8');
console.log('✓ construction-hero.svg written');

fs.writeFileSync(path.join(assetsDir, 'marketing-hero.svg'), marketing, 'utf8');
console.log('✓ marketing-hero.svg written');
